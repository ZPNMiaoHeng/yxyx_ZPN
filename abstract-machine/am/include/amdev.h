...
AM_DEVREG(11, GPU_FBDRAW,   WR, int x, y; void *pixels; int w, h; bool sync);         // pixels sync
AM_DEVREG(12, GPU_MEMCPY,   WR, uint32_t dest; void *src; int size);                  // srceen size abstract_reg

...
void Vriscv64Top___024root__traceInitSub0(Vriscv64Top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declQuad(c+1,"riscv64Top fetch pc", false,-1, 63,0);
        tracep->declQuad(c+3,"riscv64Top fetch inst", false,-1, 63,0);
...
void Vriscv64Top___024root__traceFullSub0(Vriscv64Top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullQData(oldp+1,(vlSelf->riscv64Top__DOT__fetch__DOT__pc),64);
        tracep->fullQData(oldp+3,(vlSelf->riscv64Top__DOT__fetch__DOT__inst),64);

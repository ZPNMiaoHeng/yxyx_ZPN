...
void Vriscv64Top___024root__traceInitSub0(Vriscv64Top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+238,"io_pc", false,-1, 31,0);
        tracep->declBus(c+239,"io_NextPC", false,-1, 31,0);
        ...
        tracep->declBus(c+237,"riscv64Top io_inst", false,-1, 31,0);
        tracep->declBus(c+238,"riscv64Top io_pc", false,-1, 31,0);
        tracep->declBus(c+239,"riscv64Top io_NextPC", false,-1, 31,0);
        tracep->declBit(c+236,"riscv64Top fetch_io_InstEn", false,-1);
        tracep->declBus(c+237,"riscv64Top fetch_io_InstIn", false,-1, 31,0);
        tracep->declBus(c+238,"riscv64Top fetch_io_PcIn", false,-1, 31,0);
        ...
        tracep->declBus(c+237,"riscv64Top fetch io_InstIn", false,-1, 31,0);
        tracep->declBus(c+238,"riscv64Top fetch io_PcIn", false,-1, 31,0);
        tracep->declBus(c+1,"riscv64Top fetch io_PcOut", false,-1, 31,0);
        tracep->declBus(c+2,"riscv64Top fetch io_Inst", false,-1, 31,0);
        tracep->declBus(c+237,"riscv64Top fetch ebreak_inst", false,-1, 31,0);
        tracep->declBus(c+238,"riscv64Top fetch ebreak_pc", false,-1, 31,0);
        tracep->declBit(c+240,"riscv64Top fetch Debreak", false,-1);
        tracep->declBus(c+237,"riscv64Top fetch ebreak inst", false,-1, 31,0);
        tracep->declBus(c+238,"riscv64Top fetch ebreak pc", false,-1, 31,0);
        ...
        tracep->declBus(c+241,"riscv64Top decode regs ADDR_WIDTH", false,-1, 31,0);
        tracep->declBus(c+242,"riscv64Top decode regs DATA_WIDTH", false,-1, 31,0);
        ...
        tracep->declBit(c+129,"riscv64Top decode branchCond less", false,-1);
        ...
        tracep->declBus(c+242,"riscv64Top dataMem Data_WIDTH", false,-1, 31,0);
...
void Vriscv64Top___024root__traceFullSub0(Vriscv64Top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+129,(vlSelf->riscv64Top__DOT__decode__DOT__branchCond__DOT__less));
        ...
        tracep->fullIData(oldp+237,(vlSelf->io_inst),32);
        tracep->fullIData(oldp+238,(vlSelf->io_pc),32);
        tracep->fullIData(oldp+239,(vlSelf->io_NextPC),32);
        tracep->fullBit(oldp+240,((0x100073U == vlSelf->io_inst)));
        tracep->fullIData(oldp+241,(5U),32);
        tracep->fullIData(oldp+242,(0x40U),32);
    }
}

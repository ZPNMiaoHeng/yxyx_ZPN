...
Vriscv64Top::Vriscv64Top(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_out_ar_ready{vlSymsp->TOP.io_out_ar_ready}
    , io_out_ar_valid{vlSymsp->TOP.io_out_ar_valid}
    , io_out_ar_bits_addr{vlSymsp->TOP.io_out_ar_bits_addr}
    , io_out_ar_bits_len{vlSymsp->TOP.io_out_ar_bits_len}
    , io_out_ar_bits_size{vlSymsp->TOP.io_out_ar_bits_size}
    , io_out_r_ready{vlSymsp->TOP.io_out_r_ready}
    , io_out_r_valid{vlSymsp->TOP.io_out_r_valid}
    , io_out_r_bits_last{vlSymsp->TOP.io_out_r_bits_last}
    , io_out_r_bits_resp{vlSymsp->TOP.io_out_r_bits_resp}
    , io_out_r_bits_data{vlSymsp->TOP.io_out_r_bits_data}
    , io_pc_PC{vlSymsp->TOP.io_pc_PC}
    , io_pc_nextPC{vlSymsp->TOP.io_pc_nextPC}
    , rootp{&(vlSymsp->TOP)}
{
}
...
static void _eval_initial_loop(Vriscv64Top__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("build/riscv64Top.v", 605, "",

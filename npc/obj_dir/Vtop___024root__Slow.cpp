...
void Vtop___024root___configure_coverage(Vtop___024root* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[3]), first, "vsrc/top.v", 9, 7, ".top", "v_branch/top", "if", "9-12");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[4]), first, "vsrc/top.v", 9, 8, ".top", "v_branch/top", "else", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[5]), first, "vsrc/top.v", 8, 1, ".top", "v_line/top", "block", "8,14");
}

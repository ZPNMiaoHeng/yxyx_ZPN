...
VL_MODULE(Vriscv64Top___024root) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    VL_IN8(io_out_ar_ready,0,0);
    VL_OUT8(io_out_ar_valid,0,0);
    VL_OUT8(io_out_ar_bits_len,7,0);
    VL_OUT8(io_out_ar_bits_size,2,0);
    VL_OUT8(io_out_r_ready,0,0);
    VL_IN8(io_out_r_valid,0,0);
    VL_IN8(io_out_r_bits_last,0,0);
    VL_IN8(io_out_r_bits_resp,1,0);
    VL_OUT64(io_out_ar_bits_addr,63,0);
    VL_IN64(io_out_r_bits_data,63,0);
    VL_IN64(io_pc_PC,63,0);
    VL_OUT64(io_pc_nextPC,63,0);

    // LOCAL SIGNALS
    // Anonymous structures to workaround compiler member-count bugs
    struct {
        CData/*0:0*/ riscv64Top__DOT__fetch_inst_valid;
        CData/*0:0*/ riscv64Top__DOT__alu_io_Less;
        CData/*0:0*/ riscv64Top__DOT__fetch__DOT__instHs;
        ...
        CData/*0:0*/ riscv64Top__DOT__axi__DOT__ar_hs;
        CData/*0:0*/ riscv64Top__DOT__axi__DOT__r_done;
        CData/*1:0*/ riscv64Top__DOT__axi__DOT__r_state;
        CData/*1:0*/ riscv64Top__DOT__axi__DOT___GEN_2;
        CData/*1:0*/ riscv64Top__DOT__axi__DOT___GEN_3;
        ...
        VlWide<4>/*127:0*/ riscv64Top__DOT__alu__DOT___io_Result_T_7;
        VlWide<4>/*127:0*/ riscv64Top__DOT__axi__DOT___view___05Finst_read_T;
        ...
        QData/*63:0*/ riscv64Top__DOT__axi_ar_bits_addr;
    ...
    struct {
        ...
        QData/*63:0*/ riscv64Top__DOT__axi__DOT__inst_read_h;
        QData/*63:0*/ riscv64Top__DOT__axi__DOT__inst_read_l;
    ...
    struct {
        ...
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__io_out_ar_ready;
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__io_out_ar_valid;
        CData/*7:0*/ riscv64Top__DOT____Vtogcov__io_out_ar_bits_len;
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__io_out_r_valid;
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__io_out_r_bits_last;
        CData/*1:0*/ riscv64Top__DOT____Vtogcov__io_out_r_bits_resp;
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__fetch_inst_valid;
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__fetch_inst_ready;
        ...
        CData/*0:0*/ riscv64Top__DOT____Vtogcov__axi_ar_valid;
        CData/*0:0*/ riscv64Top__DOT__fetch__DOT____Vtogcov__instHs;
    ...
    struct {
        ...
        CData/*0:0*/ riscv64Top__DOT__axi__DOT____Vtogcov__ar_hs;
        CData/*0:0*/ riscv64Top__DOT__axi__DOT____Vtogcov__r_done;
        CData/*1:0*/ riscv64Top__DOT__axi__DOT____Vtogcov__r_state;
        ...
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__io_out_ar_bits_addr;
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__io_out_r_bits_data;
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__io_pc_PC;
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__io_pc_nextPC;
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__fetch_io_Inst;
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__fetch_inst_read;
    ...
    struct {
        ...
        QData/*63:0*/ riscv64Top__DOT____Vtogcov__axi_ar_bits_addr;
        ...
        QData/*63:0*/ riscv64Top__DOT__axi__DOT____Vtogcov__inst_read_h;
        QData/*63:0*/ riscv64Top__DOT__axi__DOT____Vtogcov__inst_read_l;

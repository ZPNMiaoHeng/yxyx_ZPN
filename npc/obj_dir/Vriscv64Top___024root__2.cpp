...
void Vriscv64Top___024root___combo__TOP__4(Vriscv64Top___024root* vlSelf);
...
void Vriscv64Top___024root___eval(Vriscv64Top___024root* vlSelf) {
    ...
    // Body
    Vriscv64Top___024root___combo__TOP__4(vlSelf);
...
void Vriscv64Top___024root___eval_debug_assertions(Vriscv64Top___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->io_out_ar_ready & 0xfeU))) {
        Verilated::overWidthError("io_out_ar_ready");}
    if (VL_UNLIKELY((vlSelf->io_out_r_valid & 0xfeU))) {
        Verilated::overWidthError("io_out_r_valid");}
    if (VL_UNLIKELY((vlSelf->io_out_r_bits_last & 0xfeU))) {
        Verilated::overWidthError("io_out_r_bits_last");}
    if (VL_UNLIKELY((vlSelf->io_out_r_bits_resp & 0xfcU))) {
        Verilated::overWidthError("io_out_r_bits_resp");}
}
#endif  // VL_DEBUG

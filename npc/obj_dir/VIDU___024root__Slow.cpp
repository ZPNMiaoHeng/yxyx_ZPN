...
void VIDU___024root___ctor_var_reset(VIDU___024root* vlSelf) {
    ...
    vlSelf->IDU__DOT____Vtogcov__instJalrEn = VL_RAND_RESET_I(1);
    vlSelf->IDU__DOT____Vtogcov__instSdEn = VL_RAND_RESET_I(1);
    vlSelf->IDU__DOT____Vtogcov__instAuipcEn = VL_RAND_RESET_I(1);
    vlSelf->IDU__DOT____Vtogcov__instLuiEn = VL_RAND_RESET_I(1);
    vlSelf->IDU__DOT____Vtogcov__instJalEn = VL_RAND_RESET_I(1);
...
void VIDU___024root___configure_coverage(VIDU___024root* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[162]), first, "build/IDU.v", 16, 9, ".IDU", "v_toggle/IDU", "instJalrEn", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[163]), first, "build/IDU.v", 17, 9, ".IDU", "v_toggle/IDU", "instSdEn", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[164]), first, "build/IDU.v", 18, 9, ".IDU", "v_toggle/IDU", "instAuipcEn", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[165]), first, "build/IDU.v", 19, 9, ".IDU", "v_toggle/IDU", "instLuiEn", "");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[166]), first, "build/IDU.v", 20, 9, ".IDU", "v_toggle/IDU", "instJalEn", "");
}
